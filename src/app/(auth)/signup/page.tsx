    ...
    <div className="w-full max-w-[400px] rounded-2xl border border-neutral-200 bg-white p-8 shadow-card">
      ...
      <div className="mt-8">
        <button
          ...
          className="flex h-11 w-full items-center justify-center gap-3 rounded-lg border border-neutral-300 bg-white text-sm font-medium text-neutral-700 transition-colors hover:bg-neutral-50 disabled:opacity-50"
        >
          {googleLoading ? (
